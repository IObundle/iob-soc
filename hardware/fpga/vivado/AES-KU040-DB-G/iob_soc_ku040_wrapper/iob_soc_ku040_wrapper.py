        ...
        attributes_dict["ports"] += [
            {
                ...
                "signals": [
                    ...
                    {"name": "c0_ddr4_dm_dbi_n", "direction": "input", "width": "4"},
                    {"name": "c0_ddr4_dq", "direction": "input", "width": "32"},
                    {"name": "c0_ddr4_dqs_c", "direction": "input", "width": "4"},
                    {"name": "c0_ddr4_dqs_t", "direction": "input", "width": "4"},
                ],
            },
        ]
        ...
        attributes_dict["wires"] += [
            ...
            },
            {
                ...
                "signals": [
                    {"name": "enet_gtx_clk"},
                    {"name": "eth_clk"},
                    {"name": "high"},  # TODO: Connect to high
                    {"name": "low", "width": "1"},  # TODO: Connect to low
                    {
