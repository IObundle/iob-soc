...
ifeq ($(BOARD_SERVER),)
	...
	ssh $(BOARD_USER)@$(BOARD_SERVER) "if [ ! -d $(REMOTE_ROOT_DIR) ]; then git clone --recursive $(GITURL) $(REMOTE_ROOT_DIR); fi"
...
ifeq ($(FPGA_SERVER),)
	...
	ssh $(FPGA_USER)@$(FPGA_SERVER) "if [ ! -d $(REMOTE_ROOT_DIR) ]; then git clone --recursive $(GITURL) $(REMOTE_ROOT_DIR); fi"
