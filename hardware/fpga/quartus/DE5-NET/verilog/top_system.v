...
*/   
   ...
   generate
	 ...
	 system system (
			...
			.PCIE_CHNL_RX_IF(chnl_rx[i]),
			.PCIE_CHNL_RX_CLK_IF(chnl_rx_clk[i]),
			.PCIE_CHNL_RX_ACK_IF(chnl_rx_ack[i]),
			.PCIE_CHNL_RX_LAST_IF(chnl_rx_last[i]),
			.PCIE_CHNL_RX_LEN_IF(chnl_rx_len[`SIG_CHNL_LENGTH_W*i +:`SIG_CHNL_LENGTH_W]),
			.PCIE_CHNL_RX_OFF_IF(chnl_rx_off[`SIG_CHNL_OFFSET_W*i +:`SIG_CHNL_OFFSET_W]),
			.PCIE_CHNL_RX_DATA_IF(chnl_rx_data[C_PCI_DATA_WIDTH*i +:C_PCI_DATA_WIDTH]),
			.PCIE_CHNL_RX_DATA_VALID_IF(chnl_rx_data_valid[i]),
			.PCIE_CHNL_RX_DATA_REN_IF(chnl_rx_data_ren[i]),
			.PCIE_CHNL_TX_CLK_IF(chnl_tx_clk[i]),
			.PCIE_CHNL_TX_IF(chnl_tx[i]),
			.PCIE_CHNL_TX_ACK_IF(chnl_tx_ack[i]),
			.PCIE_CHNL_TX_LAST_IF(chnl_tx_last[i]),
			.PCIE_CHNL_TX_LEN_IF(chnl_tx_len[`SIG_CHNL_LENGTH_W*i +:`SIG_CHNL_LENGTH_W]),
			.PCIE_CHNL_TX_OFF_IF(chnl_tx_off[`SIG_CHNL_OFFSET_W*i +:`SIG_CHNL_OFFSET_W]),
			.PCIE_CHNL_TX_DATA_IF(chnl_tx_data[C_PCI_DATA_WIDTH*i +:C_PCI_DATA_WIDTH]),
			.PCIE_CHNL_TX_DATA_VALID_IF(chnl_tx_data_valid[i]),
			.PCIE_CHNL_TX_DATA_REN_IF(chnl_tx_data_ren[i])
			);
      end
   endgenerate
