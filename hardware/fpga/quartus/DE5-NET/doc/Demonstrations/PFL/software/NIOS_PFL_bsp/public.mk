...
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../S5_PFL.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x100000a8
SOPC_SYSID_FLAG += --sidp=0x100000a8
ELF_PATCH_FLAG  += --sidp 0x100000a8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1490145370
SOPC_SYSID_FLAG += --timestamp=1490145370
ELF_PATCH_FLAG  += --timestamp 1490145370
