...
`timescale 1 ps / 1 ps
module S5_PFL_mm_interconnect_1 (
		...
		input  wire        temp_sda_reset_reset_bridge_in_reset_reset,     //     temp_sda_reset_reset_bridge_in_reset.reset
		...
		output wire [1:0]  led_bracket_s1_address,                         //                           led_bracket_s1.address
		output wire        led_bracket_s1_write,                           //                                         .write
		input  wire [31:0] led_bracket_s1_readdata,                        //                                         .readdata
		output wire [31:0] led_bracket_s1_writedata,                       //                                         .writedata
		output wire        led_bracket_s1_chipselect,                      //                                         .chipselect
		output wire [1:0]  led_rj45_s1_address,                            //                              led_rj45_s1.address
		output wire        led_rj45_s1_write,                              //                                         .write
		input  wire [31:0] led_rj45_s1_readdata,                           //                                         .readdata
		output wire [31:0] led_rj45_s1_writedata,                          //                                         .writedata
		output wire        led_rj45_s1_chipselect,                         //                                         .chipselect
	...
	wire  [87:0] jtag_uart_avalon_jtag_slave_agent_rf_source_data;                   // jtag_uart_avalon_jtag_slave_agent:rf_source_data -> jtag_uart_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [87:0] jtag_uart_avalon_jtag_slave_agent_rsp_fifo_out_data;                // jtag_uart_avalon_jtag_slave_agent_rsp_fifo:out_data -> jtag_uart_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	...
	wire  [87:0] sysid_control_slave_agent_rf_source_data;                           // sysid_control_slave_agent:rf_source_data -> sysid_control_slave_agent_rsp_fifo:in_data
	...
	wire  [87:0] sysid_control_slave_agent_rsp_fifo_out_data;                        // sysid_control_slave_agent_rsp_fifo:out_data -> sysid_control_slave_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> sysid_control_slave_agent:cp_data
	...
	wire  [86:0] cmd_mux_002_src_data;                                               // cmd_mux_002:src_data -> timer_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                              // timer_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire  [10:0] cmd_mux_002_src_channel;                                            // cmd_mux_002:src_channel -> timer_s1_agent:cp_channel
	...
	wire  [87:0] button_s1_agent_rf_source_data;                                     // button_s1_agent:rf_source_data -> button_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] button_s1_agent_rsp_fifo_out_data;                                  // button_s1_agent_rsp_fifo:out_data -> button_s1_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_003_src_data;                                               // cmd_mux_003:src_data -> button_s1_agent:cp_data
	...
	wire  [87:0] led_s1_agent_rf_source_data;                                        // led_s1_agent:rf_source_data -> led_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] led_s1_agent_rsp_fifo_out_data;                                     // led_s1_agent_rsp_fifo:out_data -> led_s1_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_004_src_data;                                               // cmd_mux_004:src_data -> led_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                              // led_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire  [10:0] cmd_mux_004_src_channel;                                            // cmd_mux_004:src_channel -> led_s1_agent:cp_channel
	...
	wire  [86:0] cmd_mux_005_src_data;                                               // cmd_mux_005:src_data -> temp_sda_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                              // temp_sda_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [10:0] cmd_mux_005_src_channel;                                            // cmd_mux_005:src_channel -> temp_sda_s1_agent:cp_channel
	...
	wire         cmd_mux_006_src_valid;                                              // cmd_mux_006:src_valid -> temp_scl_s1_agent:cp_valid
	wire  [86:0] cmd_mux_006_src_data;                                               // cmd_mux_006:src_data -> temp_scl_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                              // temp_scl_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire  [10:0] cmd_mux_006_src_channel;                                            // cmd_mux_006:src_channel -> temp_scl_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                      // cmd_mux_006:src_startofpacket -> temp_scl_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                        // cmd_mux_006:src_endofpacket -> temp_scl_s1_agent:cp_endofpacket
	...
	wire  [10:0] hex0_s1_agent_m0_address;                                           // hex0_s1_agent:m0_address -> hex0_s1_translator:uav_address
	...
	wire  [87:0] hex0_s1_agent_rf_source_data;                                       // hex0_s1_agent:rf_source_data -> hex0_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] hex0_s1_agent_rsp_fifo_out_data;                                    // hex0_s1_agent_rsp_fifo:out_data -> hex0_s1_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_007_src_data;                                               // cmd_mux_007:src_data -> hex0_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                              // hex0_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [10:0] cmd_mux_007_src_channel;                                            // cmd_mux_007:src_channel -> hex0_s1_agent:cp_channel
	...
	wire  [10:0] hex1_s1_agent_m0_address;                                           // hex1_s1_agent:m0_address -> hex1_s1_translator:uav_address
	...
	wire  [87:0] hex1_s1_agent_rf_source_data;                                       // hex1_s1_agent:rf_source_data -> hex1_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] hex1_s1_agent_rsp_fifo_out_data;                                    // hex1_s1_agent_rsp_fifo:out_data -> hex1_s1_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_008_src_data;                                               // cmd_mux_008:src_data -> hex1_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                              // hex1_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [10:0] cmd_mux_008_src_channel;                                            // cmd_mux_008:src_channel -> hex1_s1_agent:cp_channel
	...
	wire  [31:0] led_rj45_s1_agent_m0_readdata;                                      // led_rj45_s1_translator:uav_readdata -> led_rj45_s1_agent:m0_readdata
	wire         led_rj45_s1_agent_m0_waitrequest;                                   // led_rj45_s1_translator:uav_waitrequest -> led_rj45_s1_agent:m0_waitrequest
	wire         led_rj45_s1_agent_m0_debugaccess;                                   // led_rj45_s1_agent:m0_debugaccess -> led_rj45_s1_translator:uav_debugaccess
	wire  [10:0] led_rj45_s1_agent_m0_address;                                       // led_rj45_s1_agent:m0_address -> led_rj45_s1_translator:uav_address
	wire   [3:0] led_rj45_s1_agent_m0_byteenable;                                    // led_rj45_s1_agent:m0_byteenable -> led_rj45_s1_translator:uav_byteenable
	wire         led_rj45_s1_agent_m0_read;                                          // led_rj45_s1_agent:m0_read -> led_rj45_s1_translator:uav_read
	wire         led_rj45_s1_agent_m0_readdatavalid;                                 // led_rj45_s1_translator:uav_readdatavalid -> led_rj45_s1_agent:m0_readdatavalid
	wire         led_rj45_s1_agent_m0_lock;                                          // led_rj45_s1_agent:m0_lock -> led_rj45_s1_translator:uav_lock
	wire  [31:0] led_rj45_s1_agent_m0_writedata;                                     // led_rj45_s1_agent:m0_writedata -> led_rj45_s1_translator:uav_writedata
	wire         led_rj45_s1_agent_m0_write;                                         // led_rj45_s1_agent:m0_write -> led_rj45_s1_translator:uav_write
	wire   [2:0] led_rj45_s1_agent_m0_burstcount;                                    // led_rj45_s1_agent:m0_burstcount -> led_rj45_s1_translator:uav_burstcount
	wire         led_rj45_s1_agent_rf_source_valid;                                  // led_rj45_s1_agent:rf_source_valid -> led_rj45_s1_agent_rsp_fifo:in_valid
	wire  [87:0] led_rj45_s1_agent_rf_source_data;                                   // led_rj45_s1_agent:rf_source_data -> led_rj45_s1_agent_rsp_fifo:in_data
	wire         led_rj45_s1_agent_rf_source_ready;                                  // led_rj45_s1_agent_rsp_fifo:in_ready -> led_rj45_s1_agent:rf_source_ready
	wire         led_rj45_s1_agent_rf_source_startofpacket;                          // led_rj45_s1_agent:rf_source_startofpacket -> led_rj45_s1_agent_rsp_fifo:in_startofpacket
	wire         led_rj45_s1_agent_rf_source_endofpacket;                            // led_rj45_s1_agent:rf_source_endofpacket -> led_rj45_s1_agent_rsp_fifo:in_endofpacket
	wire         led_rj45_s1_agent_rsp_fifo_out_valid;                               // led_rj45_s1_agent_rsp_fifo:out_valid -> led_rj45_s1_agent:rf_sink_valid
	wire  [87:0] led_rj45_s1_agent_rsp_fifo_out_data;                                // led_rj45_s1_agent_rsp_fifo:out_data -> led_rj45_s1_agent:rf_sink_data
	wire         led_rj45_s1_agent_rsp_fifo_out_ready;                               // led_rj45_s1_agent:rf_sink_ready -> led_rj45_s1_agent_rsp_fifo:out_ready
	wire         led_rj45_s1_agent_rsp_fifo_out_startofpacket;                       // led_rj45_s1_agent_rsp_fifo:out_startofpacket -> led_rj45_s1_agent:rf_sink_startofpacket
	wire         led_rj45_s1_agent_rsp_fifo_out_endofpacket;                         // led_rj45_s1_agent_rsp_fifo:out_endofpacket -> led_rj45_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_009_src_valid;                                              // cmd_mux_009:src_valid -> led_rj45_s1_agent:cp_valid
	wire  [86:0] cmd_mux_009_src_data;                                               // cmd_mux_009:src_data -> led_rj45_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                              // led_rj45_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [10:0] cmd_mux_009_src_channel;                                            // cmd_mux_009:src_channel -> led_rj45_s1_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                      // cmd_mux_009:src_startofpacket -> led_rj45_s1_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                        // cmd_mux_009:src_endofpacket -> led_rj45_s1_agent:cp_endofpacket
	wire  [31:0] led_bracket_s1_agent_m0_readdata;                                   // led_bracket_s1_translator:uav_readdata -> led_bracket_s1_agent:m0_readdata
	wire         led_bracket_s1_agent_m0_waitrequest;                                // led_bracket_s1_translator:uav_waitrequest -> led_bracket_s1_agent:m0_waitrequest
	wire         led_bracket_s1_agent_m0_debugaccess;                                // led_bracket_s1_agent:m0_debugaccess -> led_bracket_s1_translator:uav_debugaccess
	wire  [10:0] led_bracket_s1_agent_m0_address;                                    // led_bracket_s1_agent:m0_address -> led_bracket_s1_translator:uav_address
	wire   [3:0] led_bracket_s1_agent_m0_byteenable;                                 // led_bracket_s1_agent:m0_byteenable -> led_bracket_s1_translator:uav_byteenable
	wire         led_bracket_s1_agent_m0_read;                                       // led_bracket_s1_agent:m0_read -> led_bracket_s1_translator:uav_read
	wire         led_bracket_s1_agent_m0_readdatavalid;                              // led_bracket_s1_translator:uav_readdatavalid -> led_bracket_s1_agent:m0_readdatavalid
	wire         led_bracket_s1_agent_m0_lock;                                       // led_bracket_s1_agent:m0_lock -> led_bracket_s1_translator:uav_lock
	wire  [31:0] led_bracket_s1_agent_m0_writedata;                                  // led_bracket_s1_agent:m0_writedata -> led_bracket_s1_translator:uav_writedata
	wire         led_bracket_s1_agent_m0_write;                                      // led_bracket_s1_agent:m0_write -> led_bracket_s1_translator:uav_write
	wire   [2:0] led_bracket_s1_agent_m0_burstcount;                                 // led_bracket_s1_agent:m0_burstcount -> led_bracket_s1_translator:uav_burstcount
	wire         led_bracket_s1_agent_rf_source_valid;                               // led_bracket_s1_agent:rf_source_valid -> led_bracket_s1_agent_rsp_fifo:in_valid
	wire  [87:0] led_bracket_s1_agent_rf_source_data;                                // led_bracket_s1_agent:rf_source_data -> led_bracket_s1_agent_rsp_fifo:in_data
	wire         led_bracket_s1_agent_rf_source_ready;                               // led_bracket_s1_agent_rsp_fifo:in_ready -> led_bracket_s1_agent:rf_source_ready
	wire         led_bracket_s1_agent_rf_source_startofpacket;                       // led_bracket_s1_agent:rf_source_startofpacket -> led_bracket_s1_agent_rsp_fifo:in_startofpacket
	wire         led_bracket_s1_agent_rf_source_endofpacket;                         // led_bracket_s1_agent:rf_source_endofpacket -> led_bracket_s1_agent_rsp_fifo:in_endofpacket
	wire         led_bracket_s1_agent_rsp_fifo_out_valid;                            // led_bracket_s1_agent_rsp_fifo:out_valid -> led_bracket_s1_agent:rf_sink_valid
	wire  [87:0] led_bracket_s1_agent_rsp_fifo_out_data;                             // led_bracket_s1_agent_rsp_fifo:out_data -> led_bracket_s1_agent:rf_sink_data
	wire         led_bracket_s1_agent_rsp_fifo_out_ready;                            // led_bracket_s1_agent:rf_sink_ready -> led_bracket_s1_agent_rsp_fifo:out_ready
	wire         led_bracket_s1_agent_rsp_fifo_out_startofpacket;                    // led_bracket_s1_agent_rsp_fifo:out_startofpacket -> led_bracket_s1_agent:rf_sink_startofpacket
	wire         led_bracket_s1_agent_rsp_fifo_out_endofpacket;                      // led_bracket_s1_agent_rsp_fifo:out_endofpacket -> led_bracket_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_010_src_valid;                                              // cmd_mux_010:src_valid -> led_bracket_s1_agent:cp_valid
	wire  [86:0] cmd_mux_010_src_data;                                               // cmd_mux_010:src_data -> led_bracket_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                              // led_bracket_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [10:0] cmd_mux_010_src_channel;                                            // cmd_mux_010:src_channel -> led_bracket_s1_agent:cp_channel
	wire         cmd_mux_010_src_startofpacket;                                      // cmd_mux_010:src_startofpacket -> led_bracket_s1_agent:cp_startofpacket
	wire         cmd_mux_010_src_endofpacket;                                        // cmd_mux_010:src_endofpacket -> led_bracket_s1_agent:cp_endofpacket
	wire         pb_cpu_to_io_m0_agent_cp_valid;                                     // pb_cpu_to_io_m0_agent:cp_valid -> router:sink_valid
	wire  [86:0] pb_cpu_to_io_m0_agent_cp_data;                                      // pb_cpu_to_io_m0_agent:cp_data -> router:sink_data
	...
	wire  [86:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                          // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [86:0] sysid_control_slave_agent_rp_data;                                  // sysid_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [86:0] timer_s1_agent_rp_data;                                             // timer_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [86:0] button_s1_agent_rp_data;                                            // button_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [86:0] led_s1_agent_rp_data;                                               // led_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [86:0] temp_sda_s1_agent_rp_data;                                          // temp_sda_s1_agent:rp_data -> router_006:sink_data
	...
	wire         temp_scl_s1_agent_rp_valid;                                         // temp_scl_s1_agent:rp_valid -> router_007:sink_valid
	wire  [86:0] temp_scl_s1_agent_rp_data;                                          // temp_scl_s1_agent:rp_data -> router_007:sink_data
	wire         temp_scl_s1_agent_rp_ready;                                         // router_007:sink_ready -> temp_scl_s1_agent:rp_ready
	wire         temp_scl_s1_agent_rp_startofpacket;                                 // temp_scl_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         temp_scl_s1_agent_rp_endofpacket;                                   // temp_scl_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [86:0] hex0_s1_agent_rp_data;                                              // hex0_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [86:0] hex1_s1_agent_rp_data;                                              // hex1_s1_agent:rp_data -> router_009:sink_data
	...
	wire         led_rj45_s1_agent_rp_valid;                                         // led_rj45_s1_agent:rp_valid -> router_010:sink_valid
	wire  [86:0] led_rj45_s1_agent_rp_data;                                          // led_rj45_s1_agent:rp_data -> router_010:sink_data
	wire         led_rj45_s1_agent_rp_ready;                                         // router_010:sink_ready -> led_rj45_s1_agent:rp_ready
	wire         led_rj45_s1_agent_rp_startofpacket;                                 // led_rj45_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         led_rj45_s1_agent_rp_endofpacket;                                   // led_rj45_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         led_bracket_s1_agent_rp_valid;                                      // led_bracket_s1_agent:rp_valid -> router_011:sink_valid
	wire  [86:0] led_bracket_s1_agent_rp_data;                                       // led_bracket_s1_agent:rp_data -> router_011:sink_data
	wire         led_bracket_s1_agent_rp_ready;                                      // router_011:sink_ready -> led_bracket_s1_agent:rp_ready
	wire         led_bracket_s1_agent_rp_startofpacket;                              // led_bracket_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire         led_bracket_s1_agent_rp_endofpacket;                                // led_bracket_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire  [86:0] router_src_data;                                                    // router:src_data -> pb_cpu_to_io_m0_limiter:cmd_sink_data
	wire         router_src_ready;                                                   // pb_cpu_to_io_m0_limiter:cmd_sink_ready -> router:src_ready
	wire  [10:0] router_src_channel;                                                 // router:src_channel -> pb_cpu_to_io_m0_limiter:cmd_sink_channel
	...
	wire  [86:0] pb_cpu_to_io_m0_limiter_cmd_src_data;                               // pb_cpu_to_io_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         pb_cpu_to_io_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> pb_cpu_to_io_m0_limiter:cmd_src_ready
	wire  [10:0] pb_cpu_to_io_m0_limiter_cmd_src_channel;                            // pb_cpu_to_io_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [86:0] rsp_mux_src_data;                                                   // rsp_mux:src_data -> pb_cpu_to_io_m0_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                  // pb_cpu_to_io_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire  [10:0] rsp_mux_src_channel;                                                // rsp_mux:src_channel -> pb_cpu_to_io_m0_limiter:rsp_sink_channel
	...
	wire  [86:0] pb_cpu_to_io_m0_limiter_rsp_src_data;                               // pb_cpu_to_io_m0_limiter:rsp_src_data -> pb_cpu_to_io_m0_agent:rp_data
	wire         pb_cpu_to_io_m0_limiter_rsp_src_ready;                              // pb_cpu_to_io_m0_agent:rp_ready -> pb_cpu_to_io_m0_limiter:rsp_src_ready
	wire  [10:0] pb_cpu_to_io_m0_limiter_rsp_src_channel;                            // pb_cpu_to_io_m0_limiter:rsp_src_channel -> pb_cpu_to_io_m0_agent:rp_channel
	...
	wire  [10:0] pb_cpu_to_io_m0_limiter_cmd_valid_data;                             // pb_cpu_to_io_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	wire         temp_scl_s1_agent_rdata_fifo_src_valid;                             // temp_scl_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] temp_scl_s1_agent_rdata_fifo_src_data;                              // temp_scl_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         temp_scl_s1_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_006:in_0_ready -> temp_scl_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                  // avalon_st_adapter_006:out_0_valid -> temp_scl_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                   // avalon_st_adapter_006:out_0_data -> temp_scl_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                  // temp_scl_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                  // avalon_st_adapter_006:out_0_error -> temp_scl_s1_agent:rdata_fifo_sink_error
	...
	wire         led_rj45_s1_agent_rdata_fifo_src_valid;                             // led_rj45_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] led_rj45_s1_agent_rdata_fifo_src_data;                              // led_rj45_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire         led_rj45_s1_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_009:in_0_ready -> led_rj45_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_009_out_0_valid;                                  // avalon_st_adapter_009:out_0_valid -> led_rj45_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                   // avalon_st_adapter_009:out_0_data -> led_rj45_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                  // led_rj45_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                  // avalon_st_adapter_009:out_0_error -> led_rj45_s1_agent:rdata_fifo_sink_error
	wire         led_bracket_s1_agent_rdata_fifo_src_valid;                          // led_bracket_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire  [33:0] led_bracket_s1_agent_rdata_fifo_src_data;                           // led_bracket_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire         led_bracket_s1_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_010:in_0_ready -> led_bracket_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_010_out_0_valid;                                  // avalon_st_adapter_010:out_0_valid -> led_bracket_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_010_out_0_data;                                   // avalon_st_adapter_010:out_0_data -> led_bracket_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_010_out_0_ready;                                  // led_bracket_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire   [0:0] avalon_st_adapter_010_out_0_error;                                  // avalon_st_adapter_010:out_0_error -> led_bracket_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (sys_clk_clk_clk),                            //                      clk.clk
		.reset                  (temp_sda_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) led_rj45_s1_translator (
		.clk                    (sys_clk_clk_clk),                            //                      clk.clk
		.reset                  (temp_sda_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (led_rj45_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (led_rj45_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (led_rj45_s1_agent_m0_read),                  //                         .read
		.uav_write              (led_rj45_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (led_rj45_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (led_rj45_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (led_rj45_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (led_rj45_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (led_rj45_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (led_rj45_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (led_rj45_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (led_rj45_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (led_rj45_s1_write),                          //                         .write
		.av_readdata            (led_rj45_s1_readdata),                       //                         .readdata
		.av_writedata           (led_rj45_s1_writedata),                      //                         .writedata
		.av_chipselect          (led_rj45_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                           //              (terminated)
		.av_begintransfer       (),                                           //              (terminated)
		.av_beginbursttransfer  (),                                           //              (terminated)
		.av_burstcount          (),                                           //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) led_bracket_s1_translator (
		.clk                    (sys_clk_clk_clk),                            //                      clk.clk
		.reset                  (temp_sda_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (led_bracket_s1_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (led_bracket_s1_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (led_bracket_s1_agent_m0_read),               //                         .read
		.uav_write              (led_bracket_s1_agent_m0_write),              //                         .write
		.uav_waitrequest        (led_bracket_s1_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (led_bracket_s1_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (led_bracket_s1_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (led_bracket_s1_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (led_bracket_s1_agent_m0_writedata),          //                         .writedata
		.uav_lock               (led_bracket_s1_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (led_bracket_s1_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (led_bracket_s1_address),                     //      avalon_anti_slave_0.address
		.av_write               (led_bracket_s1_write),                       //                         .write
		.av_readdata            (led_bracket_s1_readdata),                    //                         .readdata
		.av_writedata           (led_bracket_s1_writedata),                   //                         .writedata
		.av_chipselect          (led_bracket_s1_chipselect),                  //                         .chipselect
		.av_read                (),                                           //              (terminated)
		.av_begintransfer       (),                                           //              (terminated)
		.av_beginbursttransfer  (),                                           //              (terminated)
		.av_burstcount          (),                                           //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (sys_clk_clk_clk),                              //             clk.clk
		.reset                   (temp_sda_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (sys_clk_clk_clk),                              //             clk.clk
		.reset                   (temp_sda_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (led_rj45_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (led_rj45_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (led_rj45_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (led_rj45_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (led_rj45_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (led_rj45_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (led_rj45_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (led_rj45_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (led_rj45_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (led_rj45_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (led_rj45_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (led_rj45_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (led_rj45_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (led_rj45_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (led_rj45_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (led_rj45_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (led_rj45_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (led_rj45_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (led_rj45_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (led_rj45_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (led_rj45_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (led_rj45_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (led_rj45_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (led_rj45_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (led_rj45_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (led_rj45_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),            //                .error
		.rdata_fifo_src_ready    (led_rj45_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (led_rj45_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (led_rj45_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) led_rj45_s1_agent_rsp_fifo (
		.clk               (sys_clk_clk_clk),                              //       clk.clk
		.reset             (temp_sda_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (led_rj45_s1_agent_rf_source_data),             //        in.data
		.in_valid          (led_rj45_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (led_rj45_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (led_rj45_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (led_rj45_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (led_rj45_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (led_rj45_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (led_rj45_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (led_rj45_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (led_rj45_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) led_bracket_s1_agent (
		.clk                     (sys_clk_clk_clk),                                 //             clk.clk
		.reset                   (temp_sda_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (led_bracket_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (led_bracket_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (led_bracket_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (led_bracket_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (led_bracket_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (led_bracket_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (led_bracket_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (led_bracket_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (led_bracket_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (led_bracket_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (led_bracket_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (led_bracket_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (led_bracket_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (led_bracket_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (led_bracket_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (led_bracket_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (led_bracket_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (led_bracket_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (led_bracket_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (led_bracket_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (led_bracket_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (led_bracket_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (led_bracket_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (led_bracket_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (led_bracket_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (led_bracket_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_010_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_010_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_010_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_010_out_0_error),               //                .error
		.rdata_fifo_src_ready    (led_bracket_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (led_bracket_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (led_bracket_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) led_bracket_s1_agent_rsp_fifo (
		.clk               (sys_clk_clk_clk),                                 //       clk.clk
		.reset             (temp_sda_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (led_bracket_s1_agent_rf_source_data),             //        in.data
		.in_valid          (led_bracket_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (led_bracket_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (led_bracket_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (led_bracket_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (led_bracket_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (led_bracket_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (led_bracket_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (led_bracket_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (led_bracket_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	S5_PFL_mm_interconnect_1_router router (
	...
	S5_PFL_mm_interconnect_1_router_001 router_001 (
	...
	S5_PFL_mm_interconnect_1_router_001 router_002 (
	...
	S5_PFL_mm_interconnect_1_router_001 router_003 (
	...
	S5_PFL_mm_interconnect_1_router_001 router_004 (
	...
	S5_PFL_mm_interconnect_1_router_001 router_005 (
	...
	S5_PFL_mm_interconnect_1_router_001 router_006 (
	...
	S5_PFL_mm_interconnect_1_router_001 router_007 (
	...
	S5_PFL_mm_interconnect_1_router_001 router_008 (
	...
	S5_PFL_mm_interconnect_1_router_001 router_009 (
	...
	S5_PFL_mm_interconnect_1_router_001 router_010 (
		.sink_ready         (led_rj45_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (led_rj45_s1_agent_rp_valid),                 //          .valid
		.sink_data          (led_rj45_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (led_rj45_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (led_rj45_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (sys_clk_clk_clk),                            //       clk.clk
		.reset              (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_router_001 router_011 (
		.sink_ready         (led_bracket_s1_agent_rp_ready),              //      sink.ready
		.sink_valid         (led_bracket_s1_agent_rp_valid),              //          .valid
		.sink_data          (led_bracket_s1_agent_rp_data),               //          .data
		.sink_startofpacket (led_bracket_s1_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (led_bracket_s1_agent_rp_endofpacket),        //          .endofpacket
		.clk                (sys_clk_clk_clk),                            //       clk.clk
		.reset              (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                 (sys_clk_clk_clk),                                //        clk.clk
		.reset               (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (sys_clk_clk_clk),                                //       clk.clk
		.reset               (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (sys_clk_clk_clk),                                //       clk.clk
		.reset               (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (sys_clk_clk_clk),                                //       clk.clk
		.reset               (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (sys_clk_clk_clk),                                //       clk.clk
		.reset               (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (sys_clk_clk_clk),                                //       clk.clk
		.reset               (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux_005 (
		.clk                 (sys_clk_clk_clk),                            //       clk.clk
		.reset               (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux_006 (
		.clk                 (sys_clk_clk_clk),                            //       clk.clk
		.reset               (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux_007 (
		.clk                 (sys_clk_clk_clk),                            //       clk.clk
		.reset               (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux_008 (
		.clk                 (sys_clk_clk_clk),                            //       clk.clk
		.reset               (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux_009 (
		.clk                 (sys_clk_clk_clk),                            //       clk.clk
		.reset               (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_cmd_mux cmd_mux_010 (
		.clk                 (sys_clk_clk_clk),                            //       clk.clk
		.reset               (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (sys_clk_clk_clk),                                //       clk.clk
		.reset              (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (sys_clk_clk_clk),                                //       clk.clk
		.reset              (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (sys_clk_clk_clk),                                //       clk.clk
		.reset              (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (sys_clk_clk_clk),                                //       clk.clk
		.reset              (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux_004 (
		.clk                (sys_clk_clk_clk),                                //       clk.clk
		.reset              (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux_005 (
		.clk                (sys_clk_clk_clk),                            //       clk.clk
		.reset              (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux_006 (
		.clk                (sys_clk_clk_clk),                            //       clk.clk
		.reset              (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux_007 (
		.clk                (sys_clk_clk_clk),                            //       clk.clk
		.reset              (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux_008 (
		.clk                (sys_clk_clk_clk),                            //       clk.clk
		.reset              (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux_009 (
		.clk                (sys_clk_clk_clk),                            //       clk.clk
		.reset              (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_demux rsp_demux_010 (
		.clk                (sys_clk_clk_clk),                            //       clk.clk
		.reset              (temp_sda_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                  (sys_clk_clk_clk),                                //       clk.clk
		.reset                (pb_cpu_to_io_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_PFL_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	S5_PFL_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (sys_clk_clk_clk),                            // in_clk_0.clk
		.in_rst_0_reset (temp_sda_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
	...
	S5_PFL_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (sys_clk_clk_clk),                            // in_clk_0.clk
		.in_rst_0_reset (temp_sda_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (led_rj45_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (led_rj45_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (led_rj45_s1_agent_rdata_fifo_src_ready),     //         .ready
	...
	S5_PFL_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (sys_clk_clk_clk),                            // in_clk_0.clk
		.in_rst_0_reset (temp_sda_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (led_bracket_s1_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (led_bracket_s1_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (led_bracket_s1_agent_rdata_fifo_src_ready),  //         .ready
