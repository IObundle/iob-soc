...
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../HELLO_QSYS.sopcinfo
...
# Design Name 
# setting SOPC_NAME is HELLO_QSYS
SOPC_NAME := HELLO_QSYS
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10000048
SOPC_SYSID_FLAG += --sidp=0x10000048
ELF_PATCH_FLAG  += --sidp 0x10000048

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1490078958
SOPC_SYSID_FLAG += --timestamp=1490078958
ELF_PATCH_FLAG  += --timestamp 1490078958
