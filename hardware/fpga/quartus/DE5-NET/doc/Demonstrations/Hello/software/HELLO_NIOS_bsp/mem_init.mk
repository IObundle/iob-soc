...
HDL_SIM_INSTALL_FILES += $(HDL_SIM_INSTALL_DIR)/$(MEM_0)_lane2.dat
HDL_SIM_INSTALL_FILES += $(HDL_SIM_INSTALL_DIR)/$(MEM_0)_lane3.dat
...
$(HDL_SIM_DIR)/$(MEM_0).dat: $(MEM_0).flash
	...
	$(FLASH2DAT) --infile=$< --outfile=$@ \
		--base=0x0 --end=0xfffffff --width=$(mem_width) \
...
MEM_1 := HELLO_QSYS_onchip_memory
...
$(MEM_1)_START := 0x11200000
$(MEM_1)_END := 0x1137ffff
$(MEM_1)_SPAN := 0x00180000
