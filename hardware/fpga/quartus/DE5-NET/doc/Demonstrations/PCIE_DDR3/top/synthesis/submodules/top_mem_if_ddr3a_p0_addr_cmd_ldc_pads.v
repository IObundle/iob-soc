...
module top_mem_if_ddr3a_p0_addr_cmd_ldc_pads (
    reset_n,
    reset_n_afi_clk,
    pll_afi_clk,
    pll_mem_clk,
...
top_mem_if_ddr3a_p0_addr_cmd_ldc_pad # (
...
top_mem_if_ddr3a_p0_addr_cmd_non_ldc_pad # (
    .AFI_DATA_WIDTH (AFI_CONTROL_WIDTH),
    .MEM_DATA_WIDTH (MEM_CONTROL_WIDTH),
    .REGISTER_C2P (REGISTER_C2P)
) ureset_n_pad (
...
generate
    ...
    begin: clock_gen
        ...
        top_mem_if_ddr3a_p0_clock_pair_generator uclk_generator (
