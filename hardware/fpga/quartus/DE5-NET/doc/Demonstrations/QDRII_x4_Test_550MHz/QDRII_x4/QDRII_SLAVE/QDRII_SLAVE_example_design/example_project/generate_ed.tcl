...
lappend arg_list "--report-file=csv:QDRII_SLAVE_example.csv"
lappend arg_list "--report-file=qip:QDRII_SLAVE_example.qip"
lappend arg_list "--output-name=QDRII_SLAVE_example"
