...
#############################################################
proc QDRII_D_example_if1_p0_perform_flexible_write_launch_timing_analysis {opcs opcname inst family scale_factors_name interface_type max_package_skew dll_length period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name} {
	...
	set k_pll_clock_id [QDRII_D_example_if1_p0_get_output_clock_id $pins(k_pins) "DQS output" msg_list]
	if {$k_pll_clock_id == -1} {
	...
	if {($result == 1)} {
		...
		foreach dpins $pins(d_groups) {
			...
			set msg_list [list]
			set leveling_delay_chain_name [QDRII_D_example_if1_p0_traverse_to_leveling_delay_chain $kpin msg_list]
						
			set dqs_periphery_node ${leveling_delay_chain_name}|clkin

			set cps_name [QDRII_D_example_if1_p0_traverse_to_clock_phase_select $kpin msg_list]
			...
			set DQSmin_of_max [QDRII_D_example_if1_p0_min_in_collection $DQSpaths_max "arrival_time"]
			set DQSmax_of_min [QDRII_D_example_if1_p0_max_in_collection $DQSpaths_min "arrival_time"]
			set DQSmax_of_max [QDRII_D_example_if1_p0_max_in_collection $DQSpaths_max "arrival_time"]
			set DQSmin_of_min [QDRII_D_example_if1_p0_min_in_collection $DQSpaths_min "arrival_time"]
			...
			set DQSperiphery_min_delay [QDRII_D_example_if1_p0_min_in_collection $DQSperiphery_min "arrival_time"]
			set DQSperiphery_max_delay [QDRII_D_example_if1_p0_max_in_collection $DQSperiphery_max "arrival_time"]
			if {($DQSperiphery_min_delay == 0) || ($DQSperiphery_max_delay == 0)} {
				return
			}
			set aiot_delay [QDRII_D_example_if1_p0_round_3dp [expr [QDRII_D_example_if1_p0_get_rise_aiot_delay $kpin] * 1e9]]
			...
			foreach dpin $dpins {
				...
				# Perform the default timing analysis to get required and arrival times
				set pin_setup_slack [QDRII_D_example_if1_p0_min_in_collection_to_name $paths_setup "slack" $dpin]
				set pin_hold_slack  [QDRII_D_example_if1_p0_min_in_collection_to_name $paths_hold "slack" $dpin]
				...
				set msg_list [list]
				set leveling_delay_chain_name [QDRII_D_example_if1_p0_traverse_to_leveling_delay_chain $dpin msg_list]
				...
				set DQmin_of_max [QDRII_D_example_if1_p0_min_in_collection $DQpaths_max "arrival_time"]
				set DQmax_of_min [QDRII_D_example_if1_p0_max_in_collection $DQpaths_min "arrival_time"]
				set DQmax_of_max [QDRII_D_example_if1_p0_max_in_collection $DQpaths_max "arrival_time"]
				set DQmin_of_min [QDRII_D_example_if1_p0_min_in_collection $DQpaths_min "arrival_time"]
				...
				set DQperiphery_min_delay [QDRII_D_example_if1_p0_min_in_collection $DQperiphery_min "arrival_time"]
				set DQperiphery_max_delay [QDRII_D_example_if1_p0_max_in_collection $DQperiphery_max "arrival_time"]
				if {($DQperiphery_min_delay == 0) || ($DQperiphery_max_delay == 0)} {
					return
				}
				set aiot_delay [QDRII_D_example_if1_p0_round_3dp [expr [QDRII_D_example_if1_p0_get_rise_aiot_delay $dpin] * 1e9]]
	...
	if {$IP(write_deskew_mode) == "dynamic"} {
		lappend wr_summary [list "  Before Calibration Write" [QDRII_D_example_if1_p0_format_3dp $default_setup_slack] [QDRII_D_example_if1_p0_format_3dp $default_hold_slack]]
	} else {
		lappend wr_summary [list "  Standard Write" [QDRII_D_example_if1_p0_format_3dp $default_setup_slack] [QDRII_D_example_if1_p0_format_3dp $default_hold_slack]]
	}
	
	if {($IP(write_deskew_mode) == "dynamic") && ($IP(mp_calibration) == 1) && ($IP(num_ranks) == 1)} {
		lappend wr_summary [list "  Memory Calibration" [QDRII_D_example_if1_p0_format_3dp $mp_setup_slack] [QDRII_D_example_if1_p0_format_3dp $mp_hold_slack]]
	}		
	...
	if {$IP(write_deskew_mode) == "dynamic"} {
		...
		set extra_shift [expr $board(intra_K_group_skew) + [QDRII_D_example_if1_p0_round_3dp [expr (1.0-$t9_vt_variation_percent)*$t(WL_PSE)]]]
		...
		lappend wr_summary [list "  Deskew Write and/or more clock pessimism removal" [QDRII_D_example_if1_p0_format_3dp $deskew_setup] [QDRII_D_example_if1_p0_format_3dp $deskew_hold]]
		...
		lappend wr_summary [list "  Quantization error" [QDRII_D_example_if1_p0_format_3dp [expr 0-$t9_quantization]] [QDRII_D_example_if1_p0_format_3dp [expr 0-$t9_quantization]]]
		...
		lappend wr_summary [list "  Calibration uncertainty" [QDRII_D_example_if1_p0_format_3dp [expr 0-$t9_variation]] [QDRII_D_example_if1_p0_format_3dp [expr 0-$t9_variation]]] 
		...
		lappend wr_summary [list "  Spatial correlation pessimism removal" [QDRII_D_example_if1_p0_format_3dp $pessimism_setup] [QDRII_D_example_if1_p0_format_3dp $pessimism_hold]]
	...
	if {($IP(write_dcc) == "dynamic")} {
		...
		lappend wr_summary [list "  Duty cycle correction quantization error" [QDRII_D_example_if1_p0_format_3dp [expr 0-$DCC_quantization]] [QDRII_D_example_if1_p0_format_3dp [expr 0-$DCC_quantization]]]
		...
		lappend wr_summary [list "  Duty cycle correction calibration uncertainity" [QDRII_D_example_if1_p0_format_3dp [expr 0-$dcc_variation]] [QDRII_D_example_if1_p0_format_3dp [expr 0-$dcc_variation]]]
	}
	...
	if {($IP(write_deskew_mode) == "dynamic")} {
		set fcolour [QDRII_D_example_if1_p0_get_colours $setup_slack $hold_slack]
		add_row_to_table -id $panel_id [list "After Calibration Write" [QDRII_D_example_if1_p0_format_3dp $setup_slack] [QDRII_D_example_if1_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Write ($opcname)" $setup_slack $hold_slack]
	} else {
		set fcolour [QDRII_D_example_if1_p0_get_colours $setup_slack $hold_slack] 
		add_row_to_table -id $panel_id [list "Write" [QDRII_D_example_if1_p0_format_3dp $setup_slack] [QDRII_D_example_if1_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Write ($opcname)" [QDRII_D_example_if1_p0_format_3dp $setup_slack] [QDRII_D_example_if1_p0_format_3dp $hold_slack]]
	}
	...
	if {[string equal -nocase $uncertainty_reporting on]} {
		...
		add_row_to_table -id $panel_id [list "  FPGA uncertainty" [QDRII_D_example_if1_p0_format_3dp $t(wru_fpga_uncertainty_s)] [QDRII_D_example_if1_p0_format_3dp $t(wru_fpga_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "  External uncertainty" [QDRII_D_example_if1_p0_format_3dp $t(wru_extl_uncertainty_s)] [QDRII_D_example_if1_p0_format_3dp $t(wru_extl_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "Deskew" "" ""]
		add_row_to_table -id $panel_id [list "  FPGA deskew" [QDRII_D_example_if1_p0_format_3dp $t(wru_fpga_deskew_s)] [QDRII_D_example_if1_p0_format_3dp $t(wru_fpga_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  External deskew" [QDRII_D_example_if1_p0_format_3dp $t(wru_external_deskew_s)] [QDRII_D_example_if1_p0_format_3dp $t(wru_external_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  Calibration uncertainty/error" [QDRII_D_example_if1_p0_format_3dp $t(wru_calibration_uncertaintyerror_s)] [QDRII_D_example_if1_p0_format_3dp $t(wru_calibration_uncertaintyerror_h)]] 
	}		
}
...
#############################################################
proc QDRII_D_example_if1_p0_perform_flexible_read_capture_timing_analysis {opcs opcname inst family scale_factors_name io_std interface_type max_package_skew dqs_phase period all_q_pins pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name} {
	...
	set fpga(tDQS_PSERR) [ expr [ get_integer_node_delay -integer $::GLOBAL_QDRII_D_example_if1_p0_dqs_delay_chain_length -parameters {IO MAX HIGH} -src DQS_PSERR -in_fitter ] / 1000.0 ]
	...
	if {($result == 1)} {
		...
		foreach qpins $pins(q_groups) {
			...
			foreach qpin $qpins {
				...
				# Perform the default timing analysis to get required and arrival times
				set pin_setup_slack [min [QDRII_D_example_if1_p0_min_in_collection_from_name $paths_setup "slack" $qpin] [QDRII_D_example_if1_p0_min_in_collection_from_name $paths_setup2 "slack" $qpin]]
				set pin_hold_slack  [min [QDRII_D_example_if1_p0_min_in_collection_from_name $paths_hold "slack" $qpin]  [QDRII_D_example_if1_p0_min_in_collection_from_name $paths_hold2 "slack" $qpin]]
	...
	set fcolour [QDRII_D_example_if1_p0_get_colours $default_setup_slack $default_hold_slack]
	if {$IP(read_deskew_mode) == "dynamic"} {
		lappend rc_summary [list "  Before Calibration Read Capture" [QDRII_D_example_if1_p0_format_3dp $default_setup_slack] [QDRII_D_example_if1_p0_format_3dp $default_hold_slack]]
	} else {
		lappend rc_summary [list "  Standard Read Capture" [QDRII_D_example_if1_p0_format_3dp $default_setup_slack] [QDRII_D_example_if1_p0_format_3dp $default_hold_slack]] 
	}
	
	if {($IP(read_deskew_mode) == "dynamic") && ($IP(mp_calibration) == 1) && ($IP(num_ranks) == 1)} {
		lappend rc_summary [list "  Memory Calibration" [QDRII_D_example_if1_p0_format_3dp $mp_setup_slack] [QDRII_D_example_if1_p0_format_3dp $mp_hold_slack]] 
	}
	...
	if {$IP(read_deskew_mode) == "dynamic"} {
		...
		set extra_shift [expr $board(intra_CQ_group_skew) + [QDRII_D_example_if1_p0_round_3dp [expr (1.0-$t1_vt_variation_percent)*$fpga(tDQS_PSERR)]]]
		...
		set deskew_setup [expr $setup_slack - $default_setup_slack - $mp_setup_slack]
		set deskew_hold  [expr $hold_slack - $default_hold_slack - $mp_hold_slack]
		lappend rc_summary [list "  Deskew Read" [QDRII_D_example_if1_p0_format_3dp $deskew_setup] [QDRII_D_example_if1_p0_format_3dp $deskew_hold]]
		...
		lappend rc_summary [list "  Quantization error" [QDRII_D_example_if1_p0_format_3dp [expr 0-$t1_quantization]] [QDRII_D_example_if1_p0_format_3dp [expr 0-$t1_quantization]]]
		
		# Consider variation in the delay chains used during dynamic deksew
		set dqs_period [QDRII_D_example_if1_p0_get_dqs_period $pins(cq_pins) ]
		...
		lappend rc_summary [list "  Calibration uncertainty" [QDRII_D_example_if1_p0_format_3dp [expr 0-$t1_variation]] [QDRII_D_example_if1_p0_format_3dp [expr 0-$t1_variation]]]
		...
		set pessimism_setup [expr $setup_slack - $default_setup_slack - $mp_setup_slack]
		set pessimism_hold  [expr $hold_slack - $default_hold_slack - $mp_hold_slack]
		lappend rc_summary [list "  Spatial correlation pessimism removal" [QDRII_D_example_if1_p0_format_3dp $pessimism_setup] [QDRII_D_example_if1_p0_format_3dp $pessimism_hold]] 
	...
	if {$IP(read_deskew_mode) == "dynamic"} {
		set fcolour [QDRII_D_example_if1_p0_get_colours $setup_slack $hold_slack] 
		add_row_to_table -id $panel_id [list "After Calibration Read Capture" [QDRII_D_example_if1_p0_format_3dp $setup_slack] [QDRII_D_example_if1_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Read Capture ($opcname)" $setup_slack $hold_slack]
	} else {
		set fcolour [QDRII_D_example_if1_p0_get_colours $setup_slack $hold_slack] 
		add_row_to_table -id $panel_id [list "Read Capture" [QDRII_D_example_if1_p0_format_3dp $setup_slack] [QDRII_D_example_if1_p0_format_3dp $hold_slack]] -fcolor $fcolour
	...
	if {[string equal -nocase $uncertainty_reporting on]} {
		...
		add_row_to_table -id $panel_id [list "Value" "Setup Side" "Hold Side"]
		add_row_to_table -id $panel_id [list "Uncertainty" "" ""]
		add_row_to_table -id $panel_id [list "  FPGA uncertainty" [QDRII_D_example_if1_p0_format_3dp $t(rdu_fpga_uncertainty_s)] [QDRII_D_example_if1_p0_format_3dp $t(rdu_fpga_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "  External uncertainty" [QDRII_D_example_if1_p0_format_3dp $t(rdu_extl_uncertainty_s)] [QDRII_D_example_if1_p0_format_3dp $t(rdu_extl_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "Deskew" "" ""]
		add_row_to_table -id $panel_id [list "  FPGA deskew" [QDRII_D_example_if1_p0_format_3dp $t(rdu_fpga_deskew_s)] [QDRII_D_example_if1_p0_format_3dp $t(rdu_fpga_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  External deskew" [QDRII_D_example_if1_p0_format_3dp $t(rdu_external_deskew_s)] [QDRII_D_example_if1_p0_format_3dp $t(rdu_external_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  Calibration uncertainty/error" [QDRII_D_example_if1_p0_format_3dp $t(rdu_calibration_uncertaintyerror_s)] [QDRII_D_example_if1_p0_format_3dp $t(rdu_calibration_uncertaintyerror_h)]] 
	}
...
proc QDRII_D_example_if1_p0_perform_phy_analyses {opcs opcname inst inst_controller pin_array_name timing_parameters_array_name summary_name IP_name} {
...
proc QDRII_D_example_if1_p0_perform_ac_analyses {opcs opcname inst scale_factors_name pin_array_name timing_parameters_array_name summary_name IP_name} {
...
proc QDRII_D_example_if1_p0_perform_resync_timing_analysis {opcs opcname inst fbasename family scale_factors_name io_std interface_type period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name SSN_name} {
	...
	set max_dqs_common_to_fifo [QDRII_D_example_if1_p0_max_in_collection [get_path -from $dqs_pins -to $fifo_in -nworst 1] "arrival_time"]
