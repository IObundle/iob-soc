...
lappend arg_list "--component-param=SEQ_ROM=QDRII_SLAVE_example_if0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=QDRII_SLAVE_example_if0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=QDRII_SLAVE_example_if0_s0_inst_ROM.hex"
...
lappend arg_list "--output-name=QDRII_SLAVE_example_if0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=STRATIXV"
lappend arg_list "--report-file=sopcinfo:QDRII_SLAVE_example_if0_s0.sopcinfo"
lappend arg_list "--report-file=txt:QDRII_SLAVE_example_if0_s0_seq_ipd_report.txt"
