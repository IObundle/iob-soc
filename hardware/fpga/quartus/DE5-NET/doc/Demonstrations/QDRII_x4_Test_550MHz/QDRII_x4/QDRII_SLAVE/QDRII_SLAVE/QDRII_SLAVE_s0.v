...
module QDRII_SLAVE_s0 (
	...
	rw_manager_qdrii #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("STRATIXV"),
		.AC_ROM_INIT_FILE_NAME                ("QDRII_SLAVE_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("QDRII_SLAVE_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (11264),
		.INIT_FILE        ("QDRII_SLAVE_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	QDRII_SLAVE_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	QDRII_SLAVE_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
