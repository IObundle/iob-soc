...
set board(intra_K_group_skew) [expr { 20 / 1000.0 }]
set board(intra_CQ_group_skew) [expr { 20 / 1000.0 }]
set board(inter_DQS_group_skew) [expr { 20 / 1000.0 }]
set board(addresscmd_CK_skew) [expr { 6 / 1000.0 }]
set board(data_K_skew)   [expr { 8 / 1000.0 }]
set board(data_CQ_skew)  [expr { 6 / 1000.0 }]
set board(intra_addr_ctrl_skew) [expr { 30 / 1000.0 }]
