...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../Golden_top.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../S5_DDR3_QSYS.sopcinfo
...
# Design Name 
# setting SOPC_NAME is S5_DDR3_QSYS
SOPC_NAME := S5_DDR3_QSYS
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x40000040
SOPC_SYSID_FLAG += --sidp=0x40000040
ELF_PATCH_FLAG  += --sidp 0x40000040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1490081008
SOPC_SYSID_FLAG += --timestamp=1490081008
ELF_PATCH_FLAG  += --timestamp 1490081008
