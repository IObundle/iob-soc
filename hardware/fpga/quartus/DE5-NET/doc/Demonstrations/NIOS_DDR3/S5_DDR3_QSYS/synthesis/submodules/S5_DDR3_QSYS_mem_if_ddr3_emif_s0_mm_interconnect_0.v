// S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0 (
	...
	wire   [2:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> sequencer_trk_mgr_inst_trkm_agent:rp_channel
	...
	wire   [2:0] rsp_mux_002_src_channel;                                                        // rsp_mux_002:src_channel -> cpu_inst_instruction_master_agent:rp_channel
	...
	wire   [2:0] cmd_mux_src_channel;                                                            // cmd_mux:src_channel -> trk_mm_bridge_s0_agent:cp_channel
	...
	wire  [93:0] cmd_mux_001_src_data;                                                           // cmd_mux_001:src_data -> sequencer_mem_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                          // sequencer_mem_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [2:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> sequencer_mem_s1_agent:cp_channel
	...
	wire  [93:0] cmd_mux_002_src_data;                                                           // cmd_mux_002:src_data -> sequencer_trk_mgr_inst_trks_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                          // sequencer_trk_mgr_inst_trks_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [2:0] cmd_mux_002_src_channel;                                                        // cmd_mux_002:src_channel -> sequencer_trk_mgr_inst_trks_agent:cp_channel
	...
	wire  [93:0] sequencer_mem_s1_agent_rp_data;                                                 // sequencer_mem_s1_agent:rp_data -> router_004:sink_data
	...
	wire         sequencer_trk_mgr_inst_trks_agent_rp_valid;                                     // sequencer_trk_mgr_inst_trks_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] sequencer_trk_mgr_inst_trks_agent_rp_data;                                      // sequencer_trk_mgr_inst_trks_agent:rp_data -> router_005:sink_data
	wire         sequencer_trk_mgr_inst_trks_agent_rp_ready;                                     // router_005:sink_ready -> sequencer_trk_mgr_inst_trks_agent:rp_ready
	wire         sequencer_trk_mgr_inst_trks_agent_rp_startofpacket;                             // sequencer_trk_mgr_inst_trks_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         sequencer_trk_mgr_inst_trks_agent_rp_endofpacket;                               // sequencer_trk_mgr_inst_trks_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [93:0] cmd_demux_002_src0_data;                                                        // cmd_demux_002:src0_data -> cmd_mux_001:sink1_data
	wire         cmd_demux_002_src0_ready;                                                       // cmd_mux_001:sink1_ready -> cmd_demux_002:src0_ready
	wire   [2:0] cmd_demux_002_src0_channel;                                                     // cmd_demux_002:src0_channel -> cmd_mux_001:sink1_channel
	...
	wire  [93:0] rsp_demux_001_src1_data;                                                        // rsp_demux_001:src1_data -> rsp_mux_002:sink0_data
	wire         rsp_demux_001_src1_ready;                                                       // rsp_mux_002:sink0_ready -> rsp_demux_001:src1_ready
	wire   [2:0] rsp_demux_001_src1_channel;                                                     // rsp_demux_001:src1_channel -> rsp_mux_002:sink0_channel
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_router router (
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_router_001 router_001 (
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_router_002 router_002 (
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_router_003 router_003 (
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_router_004 router_004 (
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_router_005 router_005 (
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_cmd_demux_001 cmd_demux_002 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	S5_DDR3_QSYS_mem_if_ddr3_emif_s0_mm_interconnect_0_rsp_mux_001 rsp_mux_002 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
