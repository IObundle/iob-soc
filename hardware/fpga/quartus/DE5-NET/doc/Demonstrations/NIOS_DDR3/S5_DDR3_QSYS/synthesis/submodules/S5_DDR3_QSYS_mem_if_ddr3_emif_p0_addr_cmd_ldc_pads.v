...
module S5_DDR3_QSYS_mem_if_ddr3_emif_p0_addr_cmd_ldc_pads (
    reset_n,
    reset_n_afi_clk,
    pll_afi_clk,
    pll_mem_clk,
...
S5_DDR3_QSYS_mem_if_ddr3_emif_p0_addr_cmd_ldc_pad # (
...
S5_DDR3_QSYS_mem_if_ddr3_emif_p0_addr_cmd_non_ldc_pad # (
    .AFI_DATA_WIDTH (AFI_CONTROL_WIDTH),
    .MEM_DATA_WIDTH (MEM_CONTROL_WIDTH),
    .REGISTER_C2P (REGISTER_C2P)
) ureset_n_pad (
