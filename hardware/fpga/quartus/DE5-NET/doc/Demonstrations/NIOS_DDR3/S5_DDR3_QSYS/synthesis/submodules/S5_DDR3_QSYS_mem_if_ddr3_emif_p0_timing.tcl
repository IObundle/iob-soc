...
# Board skews
set board(abs_max_CK_delay) 1.78
set board(abs_max_DQS_delay) 0.7
set board(minCK_DQS_skew) 0.06
set board(maxCK_DQS_skew) 1.29
set board(tpd_inter_DIMM) 0.0
set board(intra_DQS_group_skew) 0.009
set board(inter_DQS_group_skew) 0.1
set board(DQ_DQS_skew) 0.002
set board(intra_addr_ctrl_skew) 0.05
set board(addresscmd_CK_skew) 0.012
