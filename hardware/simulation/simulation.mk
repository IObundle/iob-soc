...
ifeq ($(SIM_SERVER),)
	...
	bash -c "trap 'make kill-remote-sim' EXIT; ssh $(SIM_USER)@$(SIM_SERVER) 'cd $(REMOTE_ROOT_DIR)/hardware/simulation/$(SIMULATOR); make run INIT_MEM=$(INIT_MEM) USE_DDR=$(USE_DDR) RUN_EXTMEM=$(RUN_EXTMEM) VCD=$(VCD) LOG=\"$(TEST_LOG)\"'"
ifneq ($(TEST_LOG),)
