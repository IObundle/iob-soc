...
\begin{frame}{Implementing FPGA}
\begin{itemize}
  \item Add your FPGA module in the {\tt ./hardware/fpga} folder
  ...
  \end{enumerate}
  \item To implement it, just type {\tt make fpga}
  \item To load the FPGA, type {\tt make fpga-load}
\end{itemize}
\end{frame}
