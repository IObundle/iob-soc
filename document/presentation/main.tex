...
\begin{itemize}
  \item Add your FPGA folder in {\tt ./hardware/fpga}. Use the other folders in there as examples
  \item In the file {\tt ./system.mk}:
  \begin{enumerate}
    \item Add your FPGA board name in {\tt FPGA\_BOARD}
    \item Add your server URL connected to the board in {\tt FPGA\_BOARD\_SERVER}
    \item Add further server info such as username and work directories
  \end{enumerate}
  \item To implement and load the hardware design in the FPGA, type {\tt make fpga-load}
...
\begin{itemize}
  \item Add your ASIC folder in {\tt ./hardware/asic}. Use the other folders in there as examples
  \item In the file {\tt ./system.mk}:
  \begin{enumerate}
    ...
    \item Add further server info such as username and work directories
  \end{enumerate}
  \item To implement and run the ASIC, type {\tt make asic}
\end{itemize}
\end{frame}


\begin{frame}{Implement in RTL simulation}
\begin{itemize}
  \item Add your simulation folder in {\tt ./hardware/simulation}. Use the other folders in there as examples
  \item In the file {\tt ./system.mk}:
  \begin{enumerate}
    \item Add your simulator name in {\tt SIMULATOR}
    \item Add your server URL with the RTL simulator in {\tt SIM\_SERVER}
    \item Add further server info such as username and work directories
  \end{enumerate}
  \item To implement and run the RTL simulator, type {\tt make}
\end{itemize}
\end{frame}
