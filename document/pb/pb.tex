...
\title{IOb-SoC-Yolo}
\category{IObundle System-on-Chip Platfom}
\confidential{}
...
supports stand-alone and booting modes, and can use internal RAM or an external
DDR controller via L1/L2 cache systems. The IP is currently supported in ASICs
and FPGAs. Licensable commercial versions are available.

\section*{\textcolor[rgb]{0,0,0}{Features}}
\begin{itemize}
\item 1 32-bit RISC-V control CPU
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=8.5cm]{IoB-SoC-Yolo_block_diagram.png}
