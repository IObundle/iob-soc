...
def pre_setup_iob_soc(attributes_dict, peripherals, params):
    ...
    # FIXME:build dir
    os.makedirs("../iob_soc_V0.7/software", exist_ok=True)
    with open("../iob_soc_V0.7/software/auto_sw_build.mk", "w") as file:
    ...
    if params["use_extmem"] and params["init_mem"]:
        ...
        with open("../iob_soc_V0.7/software/auto_sw_build.mk", "a") as file:
