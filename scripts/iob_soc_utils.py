...
def post_setup_iob_soc(python_module, num_extmem_connections):
    ...
    if ethernet_macro:
        ...
        contents.insert(0, 'CONSOLE_CMD=$(PYTHON_ENV) $(PYTHON_DIR)/console_ethernet.py -s /dev/usb-uart -c $(PYTHON_DIR)/console.py -m "$(RMAC_ADDR)"\n')
    ...
    if ethernet_macro:
        ...
        contents.insert(0, "\n")
        # Set custom ethernet CONSOLE_CMD
        contents.insert(0, 'CONSOLE_CMD=rm -f soc2cnsl cnsl2soc; $(PYTHON_ENV) $(PYTHON_DIR)/console_ethernet.py -L -c $(PYTHON_DIR)/console.py -m "$(RMAC_ADDR)"\n')
        contents.insert(0, "#Lines below were auto generated by iob_soc_utils.py\n")
