...
let
  py2hwsw_commit = "64e67528ed7106329090b470653d56a1318d8ecc"; # Replace with the desired commit.
  py2hwsw_sha256 = "IALS5uUa3tCXopI+r6+yWVxkM2s/gXRnI4Vck8uyrIU="; # Replace with the actual SHA256 hash.
