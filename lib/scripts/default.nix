...
let
  py2hwsw_commit = "6a26dfded288503342845fa421d3d1ee6bce021b"; # Replace with the desired commit.
  py2hwsw_sha256 = "bsRLE+dLj7Msnret3CEI7cwK8VGIftaepZ7tSpAsVg0="; # Replace with the actual SHA256 hash.
