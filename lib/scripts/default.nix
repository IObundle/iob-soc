...
let
  py2hwsw_commit = "24f47ac357b6232df07a4adeb021202adde57278"; # Replace with the desired commit.
  py2hwsw_sha256 = "qY/eg+CoEAri3KvMoLRJRaMvu66Ao5lDLigBNnQUgro="; # Replace with the actual SHA256 hash.
