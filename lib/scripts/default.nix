...
let
  py2hwsw_commit = "8da1556c2e5b5c4073b2bfabdf839525fb6f0795"; # Replace with the desired commit.
  ...
  py2hwsw = pkgs.python3.pkgs.buildPythonPackage rec {
    ...
    src = pkgs.fetchFromGitHub {
      ...
      repo = "py2hwsw";
      rev = py2hwsw_commit;
      sha256 = "xy8ZnGJWjmTu5hD9k3Ztd0kGZs41lFYUtJQvPCxCBkI=";  # Replace with the actual SHA256 hash.
    };
