...
let
  py2hwsw_commit = "1fd33b3afe912faa44fb885bd86bea4174763177"; # Replace with the desired commit.
  py2hwsw_sha256 = "vdlyRutfxq14an+QIHyK5OWwd+bheNCIN5LrrcUkWrI="; # Replace with the actual SHA256 hash.
