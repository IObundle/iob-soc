...
let
  py2hwsw_commit = "ea621ebc9def3b2ca547166b1eb03e9642fa9cf6"; # Replace with the desired commit.
  py2hwsw_sha256 = "juUdsabvgiewN+P3WNo5LM3UuHTobrJ4nXSL+g4I+1s="; # Replace with the actual SHA256 hash.
