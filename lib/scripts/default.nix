...
let
  py2hwsw_commit = "dcd94bb10ee3a355796d8ca27cad679cdf64ff55"; # Replace with the desired commit.
  py2hwsw_sha256 = "5nKQ7yVI7HIxTOsOeMishaaIcQrLpwMw+Q7Bv3Rm1ms="; # Replace with the actual SHA256 hash.
