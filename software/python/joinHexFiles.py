...
if (len(file1_contents)>total_number_of_lines/2 or len(file2_contents)>total_number_of_lines/2):
    raise Exception("Can't fit both hexfile contents in a new hexfile of size {}".format(argv[3]))
