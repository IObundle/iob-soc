...
def usage(message):
    print('{}:{}'.format(PROGNAME, "usage: ./console_ethernet.py -s <serial port> -c <console path> [ -f ] [ -L/--local ] -e <ethernet submodule directory> -i <ethernet interface> -m <ethernet mac address>"))
    cnsl_perror(message)
