...
######### In case of usage of IBUFGDS and IBUFG (differential to single edge clock##################
######## Do not forget that the clk period needs a indication of decimal houses (4 (incorrect) -> 4.0 (correct))
#create_clock -name clk -period 4.000 [get_ports C0_SYS_CLK_clk_p]  
#set_property CFGBVS VCCO [current_design] 
#######where value1 is either VCCO or GND
#set_property CONFIG_VOLTAGE 3.3 [current_design] 
########where value2 is the voltage provided to configuration bank 0
############ USE THIS FOR ONLY THE MIG ###########################################################
######## To ignore the sub-optimal clock condition of having an IO pin-BUFGCE-MMCM pair
#set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets clk] ##otherwise it will use a different route and have worse clock performance
#################################################################################################
