#include
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/include/system.vh
read_verilog ../../vivadoGUIsrcs/sources_1/imports/submodules/iob-uart/rtl/include/iob-uart.vh

#clock
#read_verilog ../../rtl/src/clock/clock_wizard.v

#system
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/top_system.v
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/system.v
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/iob_native_interconnect.v

#picorV 
read_verilog ../../vivadoGUIsrcs/sources_1/imports/iob-rv32/picorv32.v

#uart
read_verilog ../../vivadoGUIsrcs/sources_1/imports/submodules/iob-uart/rtl/src/iob-uart.v

#memory
#read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/memory/main_memory.v
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/memory/boot_memory.v
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/memory/xalt_1p_mem_no_initialization.v
read_verilog ../../vivadoGUIsrcs/sources_1/imports/submodules/iob-rv32/rtl/xalt_1p_mem.v

#cache
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/cache/afifo.v
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/cache/data_memory.v
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/cache/memory_cache_v2.v
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/cache/tag_memory.v
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/cache/valid_memory.v
#read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/cache/write_buffer.v
read_verilog ../../vivadoGUIsrcs/sources_1/imports/rtl/src/cache/xalt_1p_mem_no_initialization_with_reset.v

#read_xdc ../../vivadoGUIsrcs/constrs_1/imports/xilinx/top_system.xdc
