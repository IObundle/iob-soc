...
let
  py2hwsw_commit = "eef92a5fd77aa2cd0870f4f473fb5459b91ea540"; # Replace with the desired commit.
  py2hwsw_sha256 = "PR9u3W+Vy/VbWRlwpIqAqq36ZjjPnS11cH48hUacoMs="; # Replace with the actual SHA256 hash.
