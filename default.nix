...
let
  py2hwsw_commit = "6e60bd45737e3037a3c36737048735ab928fa29e"; # Replace with the desired commit.
  py2hwsw_sha256 = "STiiKThWc8QOfUI6drUcoAgPpzWW8S9HKV4kX2AARlc="; # Replace with the actual SHA256 hash.
