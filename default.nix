...
let
  py2hwsw_commit = "5cb995564d923887e4b2f4b962121a1fc7dcc72f"; # Replace with the desired commit.
  py2hwsw_sha256 = "YV1Zqu7x8d6lV+gmGRNLtcMjWDcN+Ch7FTO3CUliFTo="; # Replace with the actual SHA256 hash.
