...
let
  py2hwsw_commit = "6e36a33994694c76c4ef2636fd2515214311bd92"; # Replace with the desired commit.
  py2hwsw_sha256 = "xUcdu6Gxz5z8A7BBeTSW+nFnJ9xv+3NpSz48VntUfNo="; # Replace with the actual SHA256 hash.
