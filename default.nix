...
let
  py2hwsw_commit = "372d808ded6af6268965da316a292300148b434d"; # Replace with the desired commit.
  py2hwsw_sha256 = "rWsn8do1nHiIoMEPnqGbNQoHiNS8G0SD8vbtPim+Icw="; # Replace with the actual SHA256 hash.
