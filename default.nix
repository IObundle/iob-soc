...
let
  py2hwsw_commit = "1d0188c1b0178066a9e55efa533f2bf414214db3"; # Replace with the desired commit.
  py2hwsw_sha256 = "YSdbFJNnjUG1AH4ce+fBJ11Tybjc2Q7GGFopw+NnYoY="; # Replace with the actual SHA256 hash.
