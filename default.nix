...
let
  py2hwsw_commit = "e629f65efe9292ddce729ee1a62cdc7f56288c8a"; # Replace with the desired commit.
  py2hwsw_sha256 = "slUbJ2ZJL8r+j7aBhHxIBs5RUw+FfHGnTNuQk9OM+pY="; # Replace with the actual SHA256 hash.
