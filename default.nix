...
let
  py2hwsw_commit = "2a6e39b6354055f5f71d0f2ed1dc25b075407b1f"; # Replace with the desired commit.
  py2hwsw_sha256 = "B8RE8Ku8flWSOIoUcjYva1Lp1A+9pt4xga5viOdiRco="; # Replace with the actual SHA256 hash.
