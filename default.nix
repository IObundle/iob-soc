...
let
  py2hwsw_commit = "31ee61a68403ac725cb77c9d3567dd2ec4df1400"; # Replace with the desired commit.
  py2hwsw_sha256 = "fLtqdpqlEDN+sHUe5S2M0LFYtBttfZNFrAKCTbjmXho="; # Replace with the actual SHA256 hash.
