...
let
  py2hwsw_commit = "e0434c7892893cc46ca043038f42334803453fd2"; # Replace with the desired commit.
  py2hwsw_sha256 = "PG77VwJ51Yota5GO2rJqoHRJ2O1+86oUGHlCz4QKJkg="; # Replace with the actual SHA256 hash.
