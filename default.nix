...
let
  py2hwsw_commit = "c7998f186aeb8f63537f7e3b8088ca5c9834b302"; # Replace with the desired commit.
  py2hwsw_sha256 = "VdPB3Nw1s/wLqRFl3QBWLreiFkSAbkqeHxKacDG4U9Y="; # Replace with the actual SHA256 hash.
