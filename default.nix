...
let
  py2hwsw_commit = "7491fd5000281d1156ae5fca718bbbfab00015f8"; # Replace with the desired commit.
  py2hwsw_sha256 = "pwJUlpcz6O69f/rvhLNbkT5hp8jUeVyThPHMQbuaoIk="; # Replace with the actual SHA256 hash.
