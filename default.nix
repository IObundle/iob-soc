...
let
  py2hwsw_commit = "f6881ab3dcda32f9dd53a40dde9bbe7ca276b5a3"; # Replace with the desired commit.
  py2hwsw_sha256 = "/znuKdxFOy9g2AjtWlU0fS4sDVCh7XjIjGyFa8hoack="; # Replace with the actual SHA256 hash.
