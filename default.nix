...
let
  py2hwsw_commit = "fe44d650bb3455b8bcff3ecda63239eadaaa5e9c"; # Replace with the desired commit.
  py2hwsw_sha256 = "SmycmfGhVGoLWaOZzp/G09oblORNOBopYQwlyF+ymf4="; # Replace with the actual SHA256 hash.
