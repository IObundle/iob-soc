...
let
  py2hwsw_commit = "564e422a8fb66da04ee9091df8e00270091d9755"; # Replace with the desired commit.
  py2hwsw_sha256 = "4DWR876qgA+g4B0edJ9xENjZbqMnWoWokG9xp7FrTLk="; # Replace with the actual SHA256 hash.
