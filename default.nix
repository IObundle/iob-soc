...
let
  py2hwsw_commit = "131ea48a38973c0d7b84325fdef538aaa95a730f"; # Replace with the desired commit.
  py2hwsw_sha256 = "i+0/1GTmuWrtj0lJzhMtNZTIzroMYVRQQzYVZHeORz0="; # Replace with the actual SHA256 hash.
