...
def gen_linux_driver_headers():
    # invoked from the command line as:
    # python3 bootstrap.py <top_module_name> -f gen_linux_driver_headers -o [output_dir]
    ...
    top_module = init_top_module()
    top_module.gen_linux_driver_headers(output_dir)
