...
VIVADO_FLAGS= -nojournal -log reports/vivado.log -mode batch -source vivado/build.tcl -tclargs $(FPGA_TOP) $(CSR_IF) $(BOARD) "$(VSRC)" $(IS_FPGA) $(USE_EXTMEM) $(N_INTERCONNECT_SLAVES) $(SDC_PREFIX)
